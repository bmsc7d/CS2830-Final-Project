...
<html lang="en">
	...
	<div class="inline polaroid rotateRight" ondblclick="doubleClickHTML()">
		<img src="Pictures/image2.jpeg" alt="pic2">
        <h2>Arches</h2>
	</div>
    ...
    <div class="inline polaroid rotateRight" ondblclick="doubleClickHTML()">
		<img src="Pictures/image3.jpeg" alt="pic3" id="rotation">
        <h2>Arches</h2>
	</div>
            
    <div class="inline polaroid rotateRight" ondblclick="doubleClickHTML()">
		<img src="Pictures/image13.jpg" alt="pic4" id="rotation">
        <h2>Arches</h2>
	</div>
            
    <div class="inline polaroid rotateRight" ondblclick="doubleClickHTML()">
		<img src="Pictures/image14.jpg" alt="pic5" id="rotation">
        <h2>Arches</h2>
	</div>
            
    <div class="inline polaroid rotateRight" ondblclick="doubleClickHTML()">
		<img src="Pictures/image15.jpg" alt="pic6">
        <h2>Arches</h2>
	</div>
<!--
